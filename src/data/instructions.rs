...
static INSTRUCTIONS: Lazy<HashMap<u16, Row>> = Lazy::new(|| {
    HashMap::from([
        ...
        (0b01011_011_0000000, ("AMOSWAP.W", IF::R, EXT::A, 32)),
        (0b01011_011_0000001, ("AMOADD.W", IF::R, EXT::A, 32)),
        (0b01011_011_0010000, ("AMOXOR.W", IF::R, EXT::A, 32)),
        (0b01011_011_0110000, ("AMOAND.W", IF::R, EXT::A, 32)),
        (0b01011_011_0100000, ("AMOOR.W", IF::R, EXT::A, 32)),
        (0b01011_011_1000000, ("AMOMIN.W", IF::R, EXT::A, 32)),
        (0b01011_011_1010000, ("AMOMAX.W", IF::R, EXT::A, 32)),
        (0b01011_011_1100000, ("AMOMINU.W", IF::R, EXT::A, 32)),
        (0b01011_011_1110000, ("AMOMAXU.W", IF::R, EXT::A, 32)),
        ...
        (0b11110_000_0000000, ("HLV.W", IF::I, EXT::H, 64)),
        (0b11110_000_0000001, ("HSV.W", IF::S, EXT::H, 64)),
        (0b01101_000_0000000, ("LUI", IF::U, EXT::I, 32)),
        (0b00101_000_0000000, ("AUIPC", IF::U, EXT::I, 32)),
        ...
        (0b00100_011_0000000, ("SLTIU", IF::I, EXT::I, 32)),
        ...
        (0b11100_000_0000000, ("ECALL", IF::I, EXT::I, 32)),
        (0b11100_000_0000001, ("EBREAK", IF::I, EXT::I, 32)),
        (0b01100_000_0000001, ("MUL", IF::R, EXT::M, 32)),
        (0b01100_001_0000001, ("MULH", IF::R, EXT::M, 32)),
        (0b01100_010_0000001, ("MULHSU", IF::R, EXT::M, 32)),
        (0b01100_011_0000001, ("MULHU", IF::R, EXT::M, 32)),
        ...
        (0b11110_000_0000010, ("SSTC.SET", IF::I, EXT::Sstc, 64)),
        (0b11101_000_0000000, ("VADDR.TRANS", IF::I, EXT::Svadu, 64)),
        (0b00000_000_0001000, ("PAUSE.W", IF::I, EXT::Zawrs, 32)),
        (0b00010_001_0000000, ("CBO.FLUSH", IF::I, EXT::Zicbom, 32)),
        (0b00010_000_0000000, ("CBO.ZERO", IF::I, EXT::Zicboz, 32)),
        (0b11000_000_0000000, ("RDCYCLE", IF::I, EXT::Zicntr, 32)),
        (0b11000_001_0000000, ("RDTIME", IF::I, EXT::Zicntr, 32)),
        (0b11000_010_0000000, ("RDINSTRET", IF::I, EXT::Zicntr, 32)),
        (0b11100_001_0000000, ("CSRRW", IF::I, EXT::Zicsr, 32)),
        (0b11100_010_0000000, ("CSRRS", IF::I, EXT::Zicsr, 32)),
        (0b11100_011_0000000, ("CSRRC", IF::I, EXT::Zicsr, 32)),
        (0b00011_000_0000000, ("FENCE", IF::I, EXT::Zifencei, 32)),
        (0b00011_000_1000001, ("FENCE.TSO", IF::I, EXT::Zifencei, 32)),
